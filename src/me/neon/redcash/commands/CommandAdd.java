...
public class CommandAdd extends AbstractCommand {
	...
	protected ReturnType runCommand(CommandSender sender, String... args) {
		...
		if (!mc.hasAccount(RedCash.getInstance().translateNameToUUID(player.getName()))) {
	...
	public String getPermissionNode() {
		return "RedCash.command.add";
	}

	@Override
	public String getSyntax() {
		return "/cash add (jogador) (quantia)";
	}

	@Override
	public String getDescription() {
		return "Adicione um valor específicado.";
	}
}
